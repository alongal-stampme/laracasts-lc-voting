...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans bg-gray-background text-gray-900 text-sm">
        ...
        <main class="container mx-auto max-w-custom flex">
            <div class="w-70 mr-5">
                Add idea form goes here. Lorem ipsum dolor sit amet, consectetur adipisicing elit. A accusamus
                aliquam assumenda blanditiis, consectetur consequuntur eaque expedita fuga iure molestiae molestias
                odit perferendis possimus praesentium provident quam qui quis quos repudiandae sapiente sequi tempore
                ut voluptatem voluptates voluptatum. Necessitatibus, tempore.
            </div>
            <div class="w-175">
